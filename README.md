...
Download the zipped BagGetFilter_(desired python version), extract the archive, and then run the executable from the command line by moving to the directory and using the command "./BagGetFilter"
